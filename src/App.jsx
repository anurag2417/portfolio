      ...
      <section id="home" ref={heroRef} className="hero-section">
        <div className="hero-content">
          ...
          >
            <motion.span
              ...
              animate={{
                boxShadow: [
                  ...
                  "0 0 20px 10px rgba(255,107,107,0.1)",
                  "0 0 0 0 rgba(255,107,107,0)",
                ],
              }}
            ...
            >
              Pushing the boundaries of web experiences through cutting-edge 3D
          ...
          <div className="about-content">
            ...
            >
              <p className="about-quote">
                "I believe in creating experiences that blur the line between
                reality and imagination."
              </p>
              <p>
                I'm a creative developer and 3D artist with a passion for
                pushing the boundaries of what's possible on the web. With over
                5 years of experience in interactive development, I've worked
                with brands like Google, Nike, and Spotify to create immersive
